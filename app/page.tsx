...
export default function Home() {
  ...
  const handleOk = () => { console.log("Sorry, this feature is under construction."); };
  
  const handleCancel = () => { console.log("Sorry, this feature is under construction.");};
      ...
      <Organism.Jumbotron title="Welcome to Purrintables!">
        <div className="space-y-3">
          <p className="leading-10">
            Purrintables is a small business based in the Philippines. Here you can support all sorts of our products ranging from
          ...
          <p className="leading-10">
            Please read our <span className="font-bold text-[#df56c0]">FAQ</span> pages before making a purchase!
          </p>
        </div>
      </Organism.Jumbotron>
